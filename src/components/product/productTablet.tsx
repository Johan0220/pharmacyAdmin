...
import { deleteProduct, updateCapsule, updateTablet } from "@/services/apiRequest";
import { useAppDispatch, useAppSelector } from "@/redux/hooks";
import { useRouter } from "next/navigation";
import { UpdateCapsule, UpdateTablet } from "../types/typeProduct";
...
const Tablet = (props:any) => { 
      ...
      const [updateProduct, setUpdateProduct] = useState<UpdateTablet>(
        {
                id: product.id, 
                productName: product.productName,
                title: product.title,
                thumbnail: file,
                modelNumber: product.tabletP?.modelNumber,
                dies: product.tabletP?.dies,
                maxPressure: product.tabletP?.maxPressure,
                maxDiameterOfTablet: product.tabletP?.maxDiameterOfTablet,
                maxDepthOfFill: product.tabletP?.maxDepthOfFill,
                productionCapacity: product.tabletP?.productionCapacity,
                machineSize: product.tabletP?.machineSize,
                netWeight: product.tabletP?.netWeight,    
        }
      )
      const handleDelete = () => {
      ...
      const handleUpdate = () => {
            updateTablet(updateProduct,token?.accessToken,dispatch, axiosJWT)
      }
      return(
            <>       
                              ...
                              <form className="grid justify-between w-w px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6" action="">
                                    <div className="grid overflow-auto h-612 justify-between w-w px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
                                          <ul className="pr-5">
                                                ...
                                                <li className="pb-5">
                                                      <label htmlFor="output" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Model Number:</label>
                                                      <textarea id="output" name="output" onChange={handleChangeUpdate} value={updateProduct.modelNumber} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter output here"></textarea>

                                                </li>
                                                <li className="pb-5">
                                                      <label htmlFor="capsuleSize" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Dies:</label>
                                                      <textarea id="capsuleSize" name="capsuleSize" onChange={handleChangeUpdate} value={updateProduct.dies} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Capsule Size here"></textarea>                                                </li>
                                                <li className="pb-5">
                                                      <label htmlFor="machineDimension" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Max Pressure:</label>
                                                      <textarea id="machineDimension" name="machineDimension" onChange={handleChangeUpdate} value={updateProduct.maxPressure} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Machine Dimension here"></textarea>
                                                </li>
                                                
                                          </ul>
                                          <ul>
                                                <li>
                                                      <label htmlFor="shippingWeight" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Max Diameter Of Tablet:</label>
                                                      <textarea id="shippingWeight" name="shippingWeight" onChange={handleChangeUpdate} value={updateProduct.maxDiameterOfTablet} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Shipping Weight here"></textarea>
                                                </li>
                                                <li>
                                                      <label htmlFor="shippingWeight" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Max Depth Of Fill:</label>
                                                      <textarea id="shippingWeight" name="shippingWeight" onChange={handleChangeUpdate} value={updateProduct.maxDepthOfFill} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Shipping Weight here"></textarea>
                                                </li><li>
                                                      <label htmlFor="shippingWeight" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Production Capacity:</label>
                                                      <textarea id="shippingWeight" name="shippingWeight" onChange={handleChangeUpdate} value={updateProduct.productionCapacity} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Shipping Weight here"></textarea>
                                                </li><li>
                                                      <label htmlFor="shippingWeight" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Machine Size:</label>
                                                      <textarea id="shippingWeight" name="shippingWeight" onChange={handleChangeUpdate} value={updateProduct.machineSize} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Shipping Weight here"></textarea>
                                                </li><li>
                                                      <label htmlFor="shippingWeight" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Net Weight:</label>
                                                      <textarea id="shippingWeight" name="shippingWeight" onChange={handleChangeUpdate} value={updateProduct.netWeight} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Shipping Weight here"></textarea>
                                                </li>
                                          </ul>
                                          </div>
                              ...
                              <div className="grid justify-between w-w px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
                                        <div className="grid justify-between w-w px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
                                                <ul className="pr-5">
                                                        ...
                                                        <li className="pb-5">            
                                                                <div className="font-semibold">Model Number:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.modelNumber}</span>       
                                                        </li>
                                                        <li className="pb-5">                       
                                                                <div className="font-semibold">Dies:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.dies}</span>                          
                                                        </li>
                                                        <li className="pb-5">                     
                                                                <div className="font-semibold">Max Pressure:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.maxPressure}</span>
                                                        </li>
                                                </ul>
                                                ...
                                                <ul>
                                                        ...
                                                        <li className="pb-5">                     
                                                                <div className="font-semibold">Max Diameter Of Tablet:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.maxDiameterOfTablet}</span>
                                                        </li>
                                                        <li className="pb-5">                     
                                                                <div className="font-semibold">Max Depth Of Fill:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.maxDepthOfFill}</span>
                                                        </li>
                                                        <li className="pb-5">                     
                                                                <div className="font-semibold">Production Capacity:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.productionCapacity}</span>
                                                        </li>
                                                        <li className="pb-5">                     
                                                                <div className="font-semibold">Machine Size:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.machineSize}</span>
                                                        </li>
                                                        <li className="pb-5">                     
                                                                <div className="font-semibold">Net Weight:</div>
                                                                <span className="text-sm text-gray-500 dark:text-gray-400">{product.tabletP?.netWeight}</span>
                                                        </li>
                                                </ul>
                                        </div>
