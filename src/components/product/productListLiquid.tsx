...
const ProductLiquid = (props:any) => { // properties  
    ...
    return (
        <>
                ...
                <td className="px-4 py-3"><Image className="rounded-xl"  src={product.thumbnail} width="50" height="50" alt={product.productName}/></td>
