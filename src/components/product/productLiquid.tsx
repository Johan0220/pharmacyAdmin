...
import { deleteProduct, updateLiquid } from "@/services/apiRequest";
import { useAppDispatch, useAppSelector } from "@/redux/hooks";
import { useRouter } from "next/navigation";
import {  UpdateLiquid } from "../types/typeProduct";
...
const Liquid = (props:any) => { 
      ...
      const [updateProduct, setUpdateProduct] = useState<UpdateLiquid>(
            {
            id: product.id, 
            productName: product.productName,
            title: product.title,
            thumbnail: file,
            airPressure: product.liquidP?.airPressure,
            airVolume: product.liquidP?.airVolume,
            fillingSpeed: product.liquidP?.fillingSpeed,
            fillingRange: product.liquidP?.fillingRange,  
            }
      )
      const handleDelete = () => {
      ...
      const handleUpdate = () => {
            updateLiquid(updateProduct,token?.accessToken,dispatch, axiosJWT)
      }
      return(
            <>       
                              ...
                              <form className="grid justify-between w-w px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6" action="">
                                    <div className="grid overflow-auto h-612 justify-between w-w px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
                                          <ul className="pr-5">
                                                ...
                                                <li className="pb-5">
                                                      <label htmlFor="output" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Air Pressure:</label>
                                                      <textarea id="output" name="output" onChange={handleChangeUpdate} value={product.liquidP?.airPressure} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter output here"></textarea>

                                                </li>
                                                <li className="pb-5">
                                                      <label htmlFor="capsuleSize" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Air Volume:</label>
                                                      <textarea id="capsuleSize" name="capsuleSize" onChange={handleChangeUpdate} value={product.liquidP?.airVolume} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Capsule Size here"></textarea>                                                </li>
                                                <li className="pb-5">
                                                      <label htmlFor="machineDimension" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Filling Speed:</label>
                                                      <textarea id="machineDimension" name="machineDimension" onChange={handleChangeUpdate} value={product.liquidP?.fillingSpeed} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Machine Dimension here"></textarea>
                                                </li>
                                          ...
                                          <ul>
                                                <li>
                                                      ...
                                                      <label htmlFor="shippingWeight" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Filling Range:</label>
                                                      <textarea id="shippingWeight" name="shippingWeight" onChange={handleChangeUpdate} value={product.liquidP?.fillingRange} rows={3} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter Shipping Weight here"></textarea>
                                                </li>
                                          </ul>
                                          </div>
