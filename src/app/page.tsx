          ...
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div className="bg-slate-500 dark:bg-slate-400 rounded-lg">
              <div className="w-57.5 relative">
                ...
                <img className="rounded-t-lg" src="/banner.jpg" alt="picture" />
                
              </div>
                
                <div className="p-5">
                <Link href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">WELCOME PAGE FOR ADMIN</h5>
                </Link>
                <p className="mb-3 font-normal text-gray-700 dark:text-white">This website is for Admin. Please log in to continue. If you are not an employee, please leave the site.</p>
